...
NREUM.loader_config = {
  ...
  trustKey: '1433779',
  agentID: '1120273956',
  licenseKey: 'NRBR-4c8cf2306e045aad2bd',
  applicationID: '1120273956',
};
NREUM.info = {
          ...
          if (
            ...
            r.on('send-xhr-start', function (e, t) {
              g(e, t),
                (function (e) {
                  h.push(e),
                    a && (v ? v.then(A) : d ? d(A) : ((b = -b), (y.data = b)));
                })(t);
            }),
    ...
    (() => {
          ...
          const n = async () => {
            ...
            try {
              if (!this.#r(this.featureName, n))
                return (
                  (0, f.L)(this.agentIdentifier, this.featureName), void t(!1)
                );
      ...
      class j extends y {
        ...
        constructor(e, t) {
          ...
          super(e, t, P.t, r),
            g.il &&
              ((0, C.N)(
                () => (0, O.p)('docHidden', [(0, I.z)()], void 0, P.t, this.ee),
                !0
              ),
              (0, D.bP)('pagehide', () =>
              ...
              (function (e, t, r, n) {
                ...
                function b(e, r) {
                  this.xhrCbStart &&
                    t.emit(
                      'xhr-cb-time',
                      [(0, I.z)() - this.xhrCbStart, this.onload, r],
                      r
                    );
                }
                function y(e) {
      ...
      class fe extends y {
        ...
        constructor(e, r) {
          ...
          try {
            n = JSON.parse(
              localStorage.getItem(''.concat(le.Bq, '_').concat(le.K4))
            );
          } catch (e) {}
        ...
        #c(e) {
          return (
            (e &&
              (e.sessionReplayMode === le.IK.FULL ||
                e.sessionReplayMode === le.IK.ERROR)) ||
          ...
          class extends y {
            ...
            constructor(e, t) {
              ...
              this.ee.on(_e, m),
                ...
                s.buffer(
                  ['setTimeout' + ye, 'clearTimeout' + be, _e],
                  this.featureName
                ),
                d.buffer([_e, 'new-xhr', 'send-xhr' + be], this.featureName),
                l.buffer(
                  [we + be, we + '-done', we + Ae + be, we + Ae + ye],
                  this.featureName
                ),
